...
const ClientSkillsPage =  () => {
  ...
  const { total , loading , active , totalPaginate , data , getData   , SerachSkills , setActive } = useClientSkills()
  const { isModalOpen , total : fakeTotal  , editData , deleteData ,   showModal , handleCancel , handleOk} = useSkills()
