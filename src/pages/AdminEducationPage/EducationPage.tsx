...
const EducationPageAdmin = () => {
  ...
  const { total , loading , isModalOpen , active , totalPaginate , data , getData , editData , deleteData , SerachSkills , setActive , showModal , handleCancel , handleOk} = useEducation()
